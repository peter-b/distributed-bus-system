...
public class BluetoothConnectionDemo {
    ...
    public static void main(String[] args) {
        BluetoothConnectionDemo demo = new BluetoothConnectionDemo();
        demo.isDaemon = (args.length < 1);

        try {
            System.out.println(LocalDevice.getLocalDevice().getBluetoothAddress());
        } catch (BluetoothStateException e) {
            System.err.println("Bluetooth error: " + e.getMessage());
            return;
        }
        ...
        try {
            ...
            if (!demo.isDaemon) {
                ...
                bluetooth.connectDevice(args[0]);
            } else {
                System.out.println("# Listening for connections...");
                bluetooth.setListenEnabled(true);
            }
        } catch (IOException e) {
